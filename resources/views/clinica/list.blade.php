...
<body>
    ...
    height: 40px;
    border-radius: 5px;">
                <a href="{{ route('agendamento.index') }}" style="color:white; text-decoration:none">Agendar
                    Consulta</a>
            </button>
        ...
        <div style="align-self:center;" id="formulario">
            <form action="{{ route('clinica.search') }}" method="post" class="row g-3">
                ...
                <div class="col-md-8">
                    ...
                    <input style="border: 1px solid #F2D1F5; border-radius: 5px" type="text" name="valor"
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a style="color: #C770D1; margin-left: 10px"
                            href="{{ route('clinica.destroy', $item->id) }}">Excluir</a>
                    </div>
                </div>
            </div>
            @endforeach
